function changeLanguage(language) {
    ...
    if (language === 'en') {
        ...
        document.querySelector('p').textContent = 'My name is Marília Garcia, Front-end Developer';
        ...
        document.querySelector('p').textContent = 'Je m\'appelle Marília Garcia, Développeur Front-end';
        ...
        document.querySelector('p').textContent = 'Meu nome é Marília Garcia, Desenvolvedor Front-end';
